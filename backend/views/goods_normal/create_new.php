...
<section class="content">
    ...
    <div style="background:#fff;width: 100%;min-height: 935px;padding:10px 30px;">
        ...
        <h3>
            添加商品
            <a class="btn btn-primary btn-sm pull-right" href="<?= Url::to(['goods/index'])?>">返回列表</a>
        </h3>
            ...
            <from role="form">
                <div class="tab-content">
                    ...
                    <div class="tab-pane" id="tab_3">
                        <br/>
                        <div class="form-group">
                            <label for="number">商品销量</label>
                            <input type="number" class="form-control" placeholder="请填写数量" id="number"/>
                        </div>
